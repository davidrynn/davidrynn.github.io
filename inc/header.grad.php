...
<head>
  ...
  <link href='http://fonts.googleapis.com/css?family=Trade+Winds|Fugaz+One|Nunito:400,700' rel='stylesheet' type='text/css'>
...
<body id="<?php echo $page ?>">
 ...
 <!--To do
            <li <?php if ($page=="travel_blog") {echo "class='active'";} ?>><a href="contact.php">Contact</a></li>
            <li <?php if ($page=="travel_blog") {echo "class='active'";} ?>><a href="About.php">About</a></li>
 -->
